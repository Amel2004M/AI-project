...
const Welcome = () => {
  ...
  const handleClick = () => {
    if (animating) return;
    setAnimating(true);
    // Wait for animation to finish (600ms), then navigate to chat
    setTimeout(() => {
      navigate('/chat');
    }, 600);
  };
    ...
    <div className="welcome-page">
      ...
      <div className='shape6'>
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="220" viewBox="0 0 1625 316" fill="none">
          <path d="M1624.05 0C1624.05 0 1502.05 209.479 1303.13 277.861C1151.9 329.847 1044.69 313.014 878.23 310.918C640.049 307.919 482.818 336.894 274.84 224.682C127.768 145.331 1.05318 0 1.05318 0H1624.05Z" fill="#FF5CAB" stroke="#6297EC" strokeWidth="0.95803"/>
        </svg>
      </div>

      <div className='shape7'>
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="200" viewBox="0 0 1366 213" fill="none">
          <path d="M1365.24 0C1365.24 0 1315.22 112.749 1128.96 176.777C987.359 225.453 886.969 209.692 731.11 207.729C508.093 204.921 360.874 232.051 166.138 126.984C28.4293 52.6847 0.742386 0 0.742386 0H1365.24Z" fill="#7F08FF" stroke="#6297EC" strokeWidth="0.897034"/>
        </svg>
      </div>
      ...
      <div className='shape8'>
        <svg xmlns="http://www.w3.org/2000/svg" width="1170" height="124" viewBox="0 0 1170 124" fill="none">
          ...
          <path d="M979.926 90.2748C1152.7 30.8802 1168.58 -0.99998 1168.58 -0.99998L0.584625 -0.999759C0.584625 -0.999759 -7.4154 -6.7364 86.7782 44.0849C267.422 141.55 403.989 116.382 610.867 118.987C755.448 120.808 848.573 135.429 979.926 90.2748Z" stroke="#6297EC" strokeWidth="0.832121"/>
        </svg>
      </div>
     ...
     <div className='welcome-card'>
      ...
      <button className={`start-btn${animating ? ' animating' : ''}`} onClick={handleClick}>
